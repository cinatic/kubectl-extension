...
FILES :=  $(JS_FILES) $(ICON_FILES) $(SCRIPT_FILES) $(JS_COMPONENTS) $(COMPILED_SCHEMAS) $(UI_FILES) $(CSS_FILES) $(SRC_DIR)/metadata.json $(MO_FILES) README.md
